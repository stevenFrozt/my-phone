                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3  gap-5 mb-5">
                        <div className="flex items-center justify-between border-2 rounded-lg p-2">
                            <div className="ml-1">
                                ...
                                <h1 className="font-normal">Phone repair in 4 hours or less. Free diagnostic.</h1>
                            </div>
                            <div>
                        ...
                        <div className="flex items-center justify-between border-2 rounded-lg p-2">
                            <div className="ml-1">
                                ...
                                <h1 className="font-normal">Phone repairs in 2 hours or less. Deposit required.</h1>
                            </div>
                            <div>
                                <ChevronRightIcon className="h-5 cursor-pointer"/>
                            </div>
                        ...
                        <div className="flex items-center justify-between border-2 rounded-lg p-2">
                            <div  className="ml-1">
                                ...
                                <h1 className="font-normal">Free shipping both ways and repairs are completed in less than a week.</h1>
                            </div>
                            <div>
                                <ChevronRightIcon className="h-5 cursor-pointer"/>
                            </div>
