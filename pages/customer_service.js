    ...
    <>
        ...
        <div className="p-4 my-4 font-medium lg:text-xl lg:my-8 lg:border-2 lg:rounded-lg">
          ...
          <div className="font-normal">
            <h1>We're here to help! Send us your message and
          ...
          <div className="border-2 rounded-xl pb-60 font-normal max-h-1 overflow-auto
          ">
          ...
          <div className="border-2 rounded-3xl mt-4 border-red-300">
              <div className="flex items-center">
                <input placeholder="input your message" className=" w-full m-2 p-2 outline-0" type="text" />
